...
private fun deepEqualsXandr(a: Any?, b: Any?): Boolean {
  ...
  if (a is Array<*> && b is Array<*>) {
    return a.size == b.size &&
        a.indices.all{ deepEqualsXandr(a[it], b[it]) }
  }
  ...
  if (a is Map<*, *> && b is Map<*, *>) {
    return a.size == b.size && a.all {
        ...
        deepEqualsXandr(it.value, b[it.key])
    }
  }
  return a == b
}
...
data class HostAPIUserId (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return deepEqualsXandr(toList(), other.toList())  }

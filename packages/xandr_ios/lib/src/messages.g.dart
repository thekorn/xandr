...
class XandrHostApi {
  ...
  Future<bool> loadAd({required int widgetId}) async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.xandr_ios.XandrHostApi.loadAd$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
  ...
  Future<bool> setAutoRefreshInterval(int autoRefreshIntervalInSeconds,
    ...
    final String __pigeon_channelName =
        'dev.flutter.pigeon.xandr_ios.XandrHostApi.setAutoRefreshInterval$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
